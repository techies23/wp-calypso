...
-	[Node.js](http://nodejs.org/) (at least version **4.2.3**) and [NPM](https://www.npmjs.com/) installed. On Mac OS X using [brew](http://brew.sh/) is the easiest way to install or upgrade `node` and `npm`.
