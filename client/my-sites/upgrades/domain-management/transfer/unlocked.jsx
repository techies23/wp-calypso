...
import { promisy, displayRequestTransferCodeResponseNotice } from 'my-sites/upgrades/domain-management/transfer/utils';
			...
			<div>
				<SectionHeader label={ this.translate( 'Transfer Domain' ) } className="transfer__section-header">
						...
						<Button
							...
							disabled={ this.state.submitting }
							compact
							primary={ true }>{ this.translate( 'Resend Transfer Code' ) }</Button>
				</SectionHeader>
